...
```{r setup-tibble}
usernames <- c("wilsonamy", "username 1", "griffin", "username 3", "username 4") #Extend if necessary
nums <- c(18, NA, 19, NA, NA) #Extend if necessary
colours <- c("powderblue", "Colour 1", "gray50", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Hobby 1", "cycling", "Hobby 3", "Hobby 4") #Extend if necessary
