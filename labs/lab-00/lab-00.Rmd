...
```{r setup-tibble}
usernames <- c("wilsonamy", "callumknox1", "griffin", "username 3", "username 4") #Extend if necessary
nums <- c(18, 20, 19, NA, NA) #Extend if necessary
colours <- c("powderblue", "white", "gray50", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "football", "cycling", "Hobby 3", "Hobby 4") #Extend if necessary
